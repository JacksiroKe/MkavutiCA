...
Begin VB.Form frmDd_Customersx 
   ...
   ClientWidth     =   10050
   ControlBox      =   0   'False
   Icon            =   "frmDd_Customersx.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6030
   ScaleWidth      =   10050
   ...
   End
End
Attribute VB_Name = "frmDd_Customersx"
...
On Error GoTo ErrorHandler
    ...
    Rs.Open "Select Computer, Customer, Date_In, Time_In, Cost_Kes from my_clients where client_state='1'", con, adOpenStatic, adLockReadOnly
