...
Begin VB.Form frmDd_Records 
   Caption         =   "Cyber Records"
   ClientHeight    =   6030
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   15255
   ControlBox      =   0   'False
   Icon            =   "frmDd_Records.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6030
   ScaleWidth      =   15255
   ...
   End
End
Attribute VB_Name = "frmDd_Records"
...
On Error GoTo ErrorHandler
    ...
    rs.Open "Select Computer, Customer, Date_In, Time_In, Time_Out, Duration, Cost_Kes from my_records", con, adOpenStatic, adLockReadOnly
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    frmCc_Home.cmdRecords.Enabled = True
    frmCc_Home.mnuRecords.Enabled = True
End Sub
